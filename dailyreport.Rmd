...
Yesterday had `r if(yesterWx[["CsvPrecipitation"]] == "T") {
"trace"
} else if(yesterWx[["CsvPrecipitation"]] == "0.00") {
"no"
} else {
paste0("Precipitation: ", yesterWx[["CsvPrecipitation"]], '" of')
...
Yesterday had `r if(yesterWx[["CsvSnowfall"]] == "T") {
"trace"
} else if(yesterWx[["CsvSnowfall"]] == "0.0") {
"no"
} else {
paste0("Precipitation: ", yesterWx[["CsvSnowfall"]], '" of')
}` snowfall recorded.
