...
#' 
#' `plotPrecipitationOverHistory` creates a barplot with the precipitation
...
#' 
#' A barplot is plotted by [plotWithManyBars()] with the 
...
#' `daysWeather` (or, if `daysWeather` is not provided, the current
